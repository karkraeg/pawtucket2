        ...
        <div class="container">
            <div class="row"> <!-- Name und Typ -->
                <div class='col-md-12 col-lg-12'>
                    ...
                    {{{<ifdef code="ca_occurrences.nonpreferred_labels"><unit delimiter="/">Alternative Title: ^ca_occurrences.nonpreferred_labels</unit></ifdef>}}}

                    <!--
                    {{{<unit relativeTo="ca_occurrences" resrictToTypes="serie" delimiter=", ">The following numbers of the series are available in the archive: ^ca_objects.seriennummer</unit>}}}
                	-->
            ...
            <div class="row"><!-- Beschreibung, Verknüpfte Personen/Orte -->
                <div class='col-xs-12 col-md-6'
                    style="background: #F8F8F8;margin-bottom: 20px;padding: 1px 10px 10px 10px"> <!-- beschreibung -->
                    ...
                    {{{<ifdef code="ca_occurrences.werk_klassifikation"><H5>Work classification</H5>^ca_occurrences.werk_klassifikation.preferred_labels.name_singular</ifdef>}}}
                    {{{<ifdef code="ca_occurrences.mehrspieler"><H5>Game modes</H5><unit delimiter="<br/>">^ca_occurrences.mehrspieler</unit></ifdef>}}}
                    {{{<ifdef code="ca_occurrences.altersbeschraenkung"><H5>Age restriction</H5>

						<ifdef code="ca_occurrences.altersbeschraenkung.essence_line01"><b>USK:</b> ^ca_occurrences.altersbeschraenkung.essence_line01<br/></ifdef>
						<ifdef code="ca_occurrences.altersbeschraenkung.essence_line02"><b>PEGI:</b> ^ca_occurrences.altersbeschraenkung.essence_line02</ifdef>

						</ifdef>}}}
                    {{{<ifdef code="ca_occurrences.genre"><H5>Genre</H5><unit delimiter="<br/>">^ca_occurrences.genre</unit></ifdef>}}}
                    {{{<ifdef code="ca_occurrences.wikidata"><H5>Wikidata</H5><unit delimiter="<br/>"><a href="^ca_occurrences.wikidata.url" target="_blank">^ca_occurrences.wikidata</a></unit></ifdef>}}}
                    <!--
                    ...
                    {{{<ifcount code="ca_list_items" restrictToRelationshipTypes="thema" min="1">
						<h5>Topic Reference Vocabulary Term</h5>
						<ul>
					 		<li><unit relativeTo="ca_list_items" restrictToRelationshipTypes="thema" delimiter="<li>"><!-- <a href="/pawtucket/index.php/Browse/objects/facet/thema_facet/^ca_list_items.item_id" > -->^ca_list_items.preferred_labels.name_singular%delimiter=_➔_</a>
							  <ul>
                    ...
                    {{{<ifcount code="ca_list_items" restrictToRelationshipTypes="person" min="1">
						<h5>Personal reference Vocabulary term</h5>
						<ul>
                        	<li><unit relativeTo="ca_list_items" restrictToRelationshipTypes="person" delimiter="<li>"><!-- <a href="/pawtucket/index.php/Browse/werke/facet/person/id/^ca_list_items.item_id"> -->^ca_list_items.preferred_labels.name_singular%delimiter=_➔_</a>
								<ul>
							 	<ifdef code="ca_list_items.wikipedia"><li><a href="^ca_list_items.wikipedia.url" target="_blank">Wikipedia: ^ca_list_items.wikipedia</a></li></ifdef>
							 	<ifdef code="ca_list_items.artandarchitecture"><li><a href="^ca_list_items.artandarchitecture.url" target="_blank">AAT: ^ca_list_items.artandarchitecture</a></li></ifdef>
							 	<ifdef code="ca_list_items.iconclass"><li><a href="^ca_list_items.iconclass.url" target="_blank">Iconclass: ^ca_list_items.iconclass</a></li></ifdef>
                    ...
                    <!-- skipIfExpression="^ca_list_items.idno =~ /keinzeitbezug/" -->
                    {{{<ifcount code="ca_list_items" restrictToRelationshipTypes="zeit" min="1">
						<h5>Time reference vocabulary term</h5>
						<ul>
                        	<unit relativeTo="ca_list_items" restrictToRelationshipTypes="zeit" delimiter=" "><li><!-- <a href="/pawtucket/index.php/Browse/werke/facet/zeit/id/^ca_list_items.item_id"> -->^ca_list_items.preferred_labels.name_singular%delimiter=_➔_</a></unit>
                    	</ul></ifcount>}}}
                    {{{<ifdef code="ca_occurrences.entittytgn">
						<h5>Geographical reference</h5>
						<ul>
                            <unit delimiter="<br/>"><li><a href="^ca_occurrences.entittytgn.url" target="_blank">^ca_occurrences.entittytgn</a></unit>
                    	</ul></ifcount>}}}


                </div><!-- end beschreibung -->
                <div class='col-xs-12 col-md-6'
                    style="background: #F8F8F8;margin-bottom: 20px;padding: 1px 10px 10px 10px"> <!-- beschreibung 2 -->


                    {{{<ifcount code="ca_occurrences.related" restrictToTypes="werkversion" min="1" max="1"><h5>Linked work version</h5></ifcount>}}}
                    {{{<ifcount code="ca_occurrences.related" restrictToTypes="werkversion" min="2"><h5>Linked works versions</h5></ifcount>}}}
                    {{{<unit relativeTo="ca_occurrences.related" delimiter="<br/>"><a href="/index.php/Detail/werkversion/^ca_occurrences.occurrence_id">^ca_occurrences.preferred_labels.name</a></unit>}}}
